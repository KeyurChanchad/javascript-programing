...
let otherDate = new Date('8-4-2003 04:54:08');  //mm-dd-yyyy  string date
...
otherDate.toTimeString();
otherDate.toDateString();
otherDate.toLocaleDateString();
otherDate.toLocaleTimeString();
